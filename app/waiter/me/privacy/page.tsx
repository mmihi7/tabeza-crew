    ...
    <div className="page-content">
      ...
      {locations.length > 0 && (
        <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem", marginTop: "0.875rem", marginBottom: "1.5rem" }}>
          {locations.map(loc => (
            <span key={loc} style={{ display: "inline-flex", alignItems: "center", gap: "0.375rem", padding: "0.375rem 0.75rem", background: "var(--amber-pale)", border: "1px solid rgba(255,165,0,0.25)", borderRadius: "999px", fontSize: "0.8rem", fontWeight: 500, color: "var(--amber)" }}>
              {loc}
