...
import {
  Camera, ChevronRight, Bell, Shield,
  LogOut, ExternalLink,
                ...
                return (
                  <label
                    ...
                    style={{
                      ...
                      background: checked ? 'rgba(255,165,0,0.08)' : 'var(--background-primary)',
                      cursor: 'pointer',
                      fontSize: '0.75rem',
                    }}
                  >
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '0.5rem' }}>
                <div style={{ flex: 1 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.25rem', flexWrap: 'wrap' }}>
                    <span style={{ fontSize: '0.6rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.04em', padding: '0.1rem 0.5rem', borderRadius: '999px', background: 'var(--amber-pale)', color: 'var(--amber)', border: '1px solid rgba(255,165,0,0.2)' }}>
