...
export default function CrewCard({ crew, onOffer }: CrewCardProps) {
  ...
  const colors = ['#FF4F00','#3b82f6','#10b981','#ef4444','#8b5cf6']
      ...
      <div style={{ 
        ...
        <div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '0.5rem', marginBottom: '0.2rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.2rem', color: '#FF4F00', flexShrink: 0 }}>
              <Star size={12} style={{ fill: '#FF4F00' }} />
        ...
        <div style={{ display: 'flex', gap: '0.375rem', marginTop: '0.5rem', paddingTop: '0.4rem', borderTop: '1px solid #f3f4f6' }}>
          ...
          <button
            ...
            style={{
              flex: 1, padding: '0.45rem 0.5rem', background: '#FF4F00',
              border: 'none', borderRadius: '0.45rem', fontSize: '0.72rem',
