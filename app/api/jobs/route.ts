...
import { fetchOrCache, crewJobsKey } from '@/lib/cache'

// GET /api/jobs
// Returns pending hire requests + active shift postings — Redis-cached, 15s TTL
export async function GET(req: NextRequest) {
  try {
    ...
    const cacheKey = crewJobsKey(staff?.id || user.id)
