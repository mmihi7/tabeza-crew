    ...
    <div style={{ minHeight: '100%', background: 'var(--background-primary)' }}>
      ...
      <div style={{
        ...
        <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '1rem 1.25rem' }}>
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between' }}>
            ...
            <span style={{
              background: 'rgba(255,79,0,0.85)', backdropFilter: 'blur(4px)',
      ...
      <div style={{
        ...
        <Link href="#" style={{
          ...
          border: '1px solid rgba(255,79,0,0.25)', borderRadius: '0.625rem',
            ...
            {SUGGESTED_ROLES.map(role => {
              ...
              return (
                <label key={role} style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.7rem 0.8rem', borderRadius: '0.7rem', border: `1px solid ${checked ? 'var(--amber)' : 'var(--border-default)'}`, background: checked ? 'var(--amber-pale)' : 'var(--background-secondary)', cursor: 'pointer' }}>
                  ...
                  <span style={{ fontSize: '0.85rem', fontWeight: checked ? 700 : 500, color: checked ? 'var(--amber)' : 'var(--text-secondary)' }}>{role}</span>
                </label>
              )
            })}
          </div>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '0.5rem' }}>
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.25rem', flexWrap: 'wrap' }}>
                      <span style={{ fontSize: '0.65rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.04em', padding: '0.1rem 0.5rem', borderRadius: '999px', background: 'var(--amber-pale)', color: 'var(--amber)', border: '1px solid rgba(255,79,0,0.2)' }}>
