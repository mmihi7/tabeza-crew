              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: '0.375rem',
                    border: `1px solid ${isActive ? 'rgba(200,134,26,0.4)' : 'rgba(255,255,255,0.08)'}`,
                    background: isActive ? 'rgba(200,134,26,0.15)' : 'rgba(255,255,255,0.04)',
                    cursor: 'pointer',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    gap: '0.375rem',
                    color: isActive ? '#C8861A' : 'rgba(255,255,255,0.4)',
                    fontSize: '0.65rem',
