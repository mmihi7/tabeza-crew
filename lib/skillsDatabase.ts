...
export const ROLE_SKILLS_MAP: Record<string, SkillSuggestion[]> = {
  ...
  // ── Events Roles ──
  'DJ': [
    { name: 'Live Mixing', category: 'other' },
    { name: 'Turntablism', category: 'other' },
    { name: 'Crowd Reading', category: 'other' },
    { name: 'Music Programming', category: 'other' },
    { name: 'Sound System Setup', category: 'other' },
    { name: 'Music Library Curation', category: 'other' },
    { name: 'Equipment Maintenance', category: 'other' },
  ],
  'MC / Host': [
    { name: 'Public Speaking', category: 'other' },
    { name: 'Crowd Engagement', category: 'other' },
    { name: 'Event Flow', category: 'other' },
    { name: 'Script Writing', category: 'other' },
    { name: 'Improvisation', category: 'other' },
    { name: 'Stage Presence', category: 'other' },
    { name: 'Bilingual Hosting', category: 'other' },
  ],
  'Videographer': [
    { name: 'Camera Operation', category: 'other' },
    { name: 'Video Editing', category: 'other' },
    { name: 'Live Streaming', category: 'other' },
    { name: 'Color Grading', category: 'other' },
    { name: 'Drone Operation', category: 'other' },
    { name: 'Lighting for Video', category: 'other' },
    { name: 'Storyboarding', category: 'other' },
  ],
  'Photographer': [
    { name: 'Event Photography', category: 'other' },
    { name: 'Portrait Photography', category: 'other' },
    { name: 'Photo Editing', category: 'other' },
    { name: 'Lighting Setup', category: 'other' },
    { name: 'Drone Photography', category: 'other' },
    { name: 'Photo Delivery Workflow', category: 'other' },
  ],
  'Lighting Technician': [
    { name: 'Lighting Design', category: 'other' },
    { name: 'DMX Programming', category: 'other' },
    { name: 'Stage Lighting', category: 'other' },
    { name: 'Follow Spot', category: 'other' },
    { name: 'Power Distribution', category: 'other' },
    { name: 'Equipment Maintenance', category: 'other' },
  ],
  'Sound Engineer': [
    { name: 'Live Sound Mixing', category: 'other' },
    { name: 'PA Setup', category: 'other' },
    { name: 'Monitor Mixing', category: 'other' },
    { name: 'Feedback Control', category: 'other' },
    { name: 'Wireless Systems', category: 'other' },
    { name: 'Audio Recording', category: 'other' },
  ],
  'Rigger': [
    { name: 'Rigging', category: 'other' },
    { name: 'Truss Assembly', category: 'other' },
    { name: 'Motor & Hoist Operation', category: 'other' },
    { name: 'Load Calculations', category: 'other' },
    { name: 'Height Safety', category: 'other' },
    { name: 'Knot Tying', category: 'other' },
  ],
  'Comedian': [
    { name: 'Stand-up Comedy', category: 'other' },
    { name: 'Improvisation', category: 'other' },
    { name: 'Crowd Work', category: 'other' },
    { name: 'Script Writing', category: 'other' },
    { name: 'Timing & Delivery', category: 'other' },
    { name: 'Audience Engagement', category: 'other' },
  ],
  'Live Musician': [
    { name: 'Live Performance', category: 'other' },
    { name: 'Instrument Proficiency', category: 'other' },
    { name: 'Improvisation', category: 'other' },
    { name: 'Stage Presence', category: 'other' },
    { name: 'Rehearsal', category: 'other' },
    { name: 'Ear Training', category: 'other' },
  ],
  'Dancer / Performer': [
    { name: 'Choreography', category: 'other' },
    { name: 'Stage Performance', category: 'other' },
    { name: 'Partner Work', category: 'other' },
    { name: 'Flexibility & Conditioning', category: 'other' },
    { name: 'Costume & Makeup', category: 'other' },
    { name: 'Rehearsal Discipline', category: 'other' },
  ],
  'Event Coordinator': [
    { name: 'Event Planning', category: 'other' },
    { name: 'Vendor Coordination', category: 'other' },
    { name: 'Run of Show', category: 'other' },
    { name: 'Budgeting', category: 'other' },
    { name: 'Timeline Management', category: 'other' },
    { name: 'Client Communication', category: 'other' },
  ],
  'Stagehand': [
    { name: 'Stage Setup', category: 'other' },
    { name: 'Equipment Handling', category: 'other' },
    { name: 'Cue Discipline', category: 'other' },
    { name: 'Load-in / Load-out', category: 'other' },
    { name: 'Backline Setup', category: 'other' },
    { name: 'Safety Compliance', category: 'other' },
  ],
}
